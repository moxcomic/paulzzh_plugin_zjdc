...
(function() {
    ...
    paulzzh_plugin_zjdc.server = "https://majsoul.paulzzh.tech/api/v2/zjdc?ios=1";
    ...
    paulzzh_plugin_zjdc.xhr = function(vui,account_id,which,t) {
        ...
        xhr.setRequestHeader("Paulzzh-Plugin-Zjdc",btoa(encodeURIComponent(JSON.stringify(tosend))));
        console.log(tosend);
